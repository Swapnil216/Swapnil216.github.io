    ...
    <main className="bg-[#F8F9FA] text-gray-900 font-sans antialiased min-h-screen scroll-smooth">
      ...
      <nav className="fixed w-full top-0 bg-[#F8F9FA]/90 backdrop-blur-md z-50 py-4 px-8 flex justify-between items-center shadow-sm">
        ...
        <div className="flex space-x-4 items-center">
          <a href="/Swapnil_Agarwal_Resume_2.pdf" target="_blank" rel="noopener noreferrer" className="bg-blue-600 text-white px-4 py-2 rounded-full text-sm font-semibold hover:bg-blue-700 transition">
      ...
      <section id="about" className="min-h-screen flex items-center justify-center px-8 pt-20">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center">
            ...
            <div className="absolute bottom-4 right-10 bg-white px-4 py-2 rounded-xl shadow-lg font-bold text-blue-600 z-20 flex items-center">
      ...
      <section id="experience" className="py-20 px-8 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-5xl font-black text-center mb-4 uppercase">Where I've <span className="text-blue-600">Made Impact</span></h2>
          ...
          <div className="relative border-l-4 border-blue-100 ml-6 md:ml-0 md:pl-12 space-y-16">
              ...
              <div className="bg-[#F8F9FA] rounded-2xl p-8 shadow-sm hover:shadow-md transition border border-gray-100">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <p className="text-blue-600 font-semibold text-lg">Delivery Hero &bull; Berlin, Germany</p>
                  </div>
                  <div className="text-right text-sm text-gray-500 shrink-0">
                    <p><i className="far fa-calendar-alt mr-1"></i> Apr 2025 - Present</p>
                    <span className="inline-block bg-green-100 text-green-700 px-2 py-1 rounded text-xs mt-2 font-bold uppercase">Full-Time</span>
                  </div>
                </div>
              ...
              <div className="bg-[#F8F9FA] rounded-2xl p-8 shadow-sm hover:shadow-md transition border border-gray-100">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <p className="text-blue-600 font-semibold text-lg">Flipkart &bull; Bengaluru, India</p>
                  </div>
                  <div className="text-right text-sm text-gray-500 shrink-0">
                ...
                <div className="text-gray-700 space-y-4">
                  <div>
                    <strong className="text-gray-900 block mb-1">Multi Category Store - Spark, Python, Couchbase, JAVA</strong>
                  ...
                  <div>
                    <strong className="text-gray-900 block mb-1">Dynamic Sale Price - JAVA, Kafka, RESTful API</strong>
                    <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <div className="relative">
              ...
              <div className="bg-[#F8F9FA] rounded-2xl p-8 shadow-sm hover:shadow-md transition border border-gray-100">
                ...
                <div className="text-gray-700 space-y-4">
                  <div>
                    <strong className="text-gray-900 block mb-1">A/B Capability in Search System - MySQL, JAVA</strong>
                    <p className="ml-2">• Developed highly customisable A/B testing infrastructure for the search system, enabling real-time experimentation of new features, facilitating data-driven decisions for feature rollouts.</p>
                  </div>
                  <div>
                    <strong className="text-gray-900 block mb-1">Cloud Migration - Kubernetes, Google Cloud Platform</strong>
                    <p className="ml-2">• Led the seamless migration of both stateful and stateless search services to Google Cloud Platform (GCP), ensuring improved scalability to support future business growth and traffic demands.</p>
                  </div>
                  <div>
                    <strong className="text-gray-900 block mb-1">Elite Brand Search - JAVA, HBase, RESTful API</strong>
                    <ul className="list-disc list-inside space-y-1 ml-2">
                  ...
                  <div>
                    <strong className="text-gray-900 block mb-1">Semantic Matching - Solr, Zookeeper, RESTful API</strong>
                    <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <div className="bg-[#F8F9FA] rounded-2xl p-8 shadow-sm hover:shadow-md transition border border-gray-100">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div className="text-right text-sm text-gray-500 shrink-0">
                    ...
                    <span className="inline-block bg-blue-100 text-blue-700 px-2 py-1 rounded text-xs mt-2 font-bold uppercase">Internship</span>
                  </div>
                </div>
                <div className="text-gray-700 space-y-4">
                  <div>
                    <strong className="text-gray-900 block mb-1">Flash POC: Semantic Matching - Solr, Gradle</strong>
                    <ul className="list-disc list-inside space-y-1 ml-2">
                  ...
                  <div>
                    <strong className="text-gray-900 block mb-1">Intelligent Product Insights - Python, DropWizard</strong>
                    <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <div className="relative">
              ...
              <div className="bg-[#F8F9FA] rounded-2xl p-8 shadow-sm hover:shadow-md transition border border-gray-100">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900">Full Stack Software Developer Research Intern</h3>
                    <p className="text-purple-600 font-semibold text-lg">UCL &bull; London, UK</p>
                  </div>
                  <div className="text-right text-sm text-gray-500 shrink-0">
                    <p><i className="far fa-calendar-alt mr-1"></i> May 2021 - Jul 2021</p>
                    <span className="inline-block bg-purple-100 text-purple-700 px-2 py-1 rounded text-xs mt-2 font-bold uppercase">Research</span>
                  </div>
                </div>
            ...
            <div className="relative">
              ...
              <div className="bg-[#F8F9FA] rounded-2xl p-8 shadow-sm hover:shadow-md transition border border-gray-100">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900">Software Development Engineer Intern</h3>
                    <p className="text-red-600 font-semibold text-lg">Eindhoven University of Technology &bull; Netherlands</p>
                  </div>
                  <div className="text-right text-sm text-gray-500 shrink-0">
                    <p><i className="far fa-calendar-alt mr-1"></i> May 2021 - Jul 2021</p>
                    <span className="inline-block bg-red-100 text-red-700 px-2 py-1 rounded text-xs mt-2 font-bold uppercase">Internship</span>
                  </div>
                </div>
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-2">
              ...
              <div className="bg-[#F8F9FA] rounded-2xl p-8 shadow-sm hover:shadow-md transition border border-gray-100">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <p className="text-gray-600 font-semibold text-lg">IMARC Services Private Limited &bull; Noida, India</p>
                  </div>
                  <div className="text-right text-sm text-gray-500 shrink-0">
                    <p><i className="far fa-calendar-alt mr-1"></i> May 2019 - Jul 2019</p>
                    <span className="inline-block bg-gray-200 text-gray-700 px-2 py-1 rounded text-xs mt-2 font-bold uppercase">Internship</span>
                  </div>
                </div>
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-2">
      ...
      <section id="projects" className="py-20 px-8 bg-[#F8F9FA]">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-5xl font-black mb-4 uppercase">Side <span className="text-blue-600">Projects</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition flex flex-col h-full">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-gray-900 leading-tight">Blockchain</h3>
                <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[10px] font-bold whitespace-nowrap ml-2">Apr '21</span>
              </div>
              <p className="text-xs text-blue-600 font-semibold mb-3">BITS Pilani</p>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition flex flex-col h-full">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-gray-900 leading-tight">File Transfer using UDP</h3>
                <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[10px] font-bold whitespace-nowrap ml-2">Mar '21 - Apr '21</span>
              </div>
              <p className="text-xs text-blue-600 font-semibold mb-3">BITS Pilani</p>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition flex flex-col h-full">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-gray-900 leading-tight">Webpage Retrieval using TCP sockets</h3>
                <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[10px] font-bold whitespace-nowrap ml-2">Feb '21</span>
              </div>
              <p className="text-xs text-blue-600 font-semibold mb-3">BITS Pilani</p>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition flex flex-col h-full">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-gray-900 leading-tight">Automated Chatbot</h3>
                <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[10px] font-bold whitespace-nowrap ml-2">Dec '20 - Jan '21</span>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition flex flex-col h-full">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-gray-900 leading-tight">Virtual Assistant</h3>
                <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[10px] font-bold whitespace-nowrap ml-2">Dec '20</span>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition flex flex-col h-full">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-gray-900 leading-tight">Reducate</h3>
                <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[10px] font-bold whitespace-nowrap ml-2">Sep '20 - Nov '20</span>
              </div>
              <p className="text-xs text-blue-600 font-semibold mb-3">BITS Pilani</p>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition flex flex-col h-full">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-gray-900 leading-tight">Automated Classifier between Animals</h3>
                <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[10px] font-bold whitespace-nowrap ml-2">May '20</span>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition flex flex-col h-full">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-gray-900 leading-tight">Facial Expression Recogniser</h3>
                <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[10px] font-bold whitespace-nowrap ml-2">May '20</span>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition flex flex-col h-full">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-gray-900 leading-tight">Stock Price Movement Model</h3>
                <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[10px] font-bold whitespace-nowrap ml-2">Mar '20 - May '20</span>
              </div>
              <p className="text-xs text-blue-600 font-semibold mb-3">BITS Pilani</p>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition flex flex-col h-full">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-gray-900 leading-tight">Stock Options and Futures Risk Analysis</h3>
                <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[10px] font-bold whitespace-nowrap ml-2">Mar '20 - Apr '20</span>
              </div>
              <p className="text-xs text-blue-600 font-semibold mb-3">BITS Pilani</p>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition flex flex-col h-full">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-gray-900 leading-tight">Cab Booking and Management System</h3>
                <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[10px] font-bold whitespace-nowrap ml-2">Sep '19 - Nov '19</span>
              </div>
              <p className="text-xs text-blue-600 font-semibold mb-3">BITS Pilani</p>
      ...
      <section id="skills" className="py-20 px-8 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-5xl font-black mb-4 uppercase">My <span className="text-blue-600">Superpowers</span></h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left mb-12">
            ...
            <div className="bg-[#F8F9FA] p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
              <h3 className="text-xl font-bold mb-6 flex items-center"><i className="fas fa-code text-purple-500 mr-3"></i> Core & Frameworks</h3>
            ...
            {/* Infrastructure */}
            <div className="bg-[#F8F9FA] p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
              <h3 className="text-xl font-bold mb-6 flex items-center"><i className="fas fa-server text-orange-500 mr-3"></i> Infrastructure & DBs</h3>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="bg-[#F8F9FA] p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
              <h3 className="text-xl font-bold mb-6 flex items-center"><i className="fas fa-toolbox text-blue-500 mr-3"></i> Tools & Misc</h3>
              <div className="flex flex-wrap gap-2">
          ...
          <div className="bg-[#F8F9FA] p-8 rounded-2xl border border-gray-100 text-left shadow-sm hover:shadow-md transition">
            <h3 className="text-xl font-bold mb-4 flex items-center"><i className="fas fa-certificate text-yellow-500 mr-3"></i> Certifications</h3>
            <ul className="grid md:grid-cols-3 gap-4 text-gray-700">
               <li className="flex items-start bg-white p-4 rounded-xl border border-gray-100 flex-col shadow-sm">
                 <div className="flex items-center">
                   ...
                   <span className="font-bold text-gray-800">Tweet Emotion Recognition with TensorFlow</span>
                 </div>
                 <div className="text-xs text-gray-400 mt-2 ml-7 bg-gray-50 px-2 py-1 rounded-md border border-gray-200 self-start">ID: C29W2RJM5583</div>
               </li>
               <li className="flex items-start bg-white p-4 rounded-xl border border-gray-100 flex-col shadow-sm">
                 <div className="flex items-center">
                   <i className="fas fa-check-circle text-green-500 mr-3"></i>
                   <span className="font-bold text-gray-800">Introduction to Data Science in Python</span>
                 </div>
                 <div className="text-xs text-gray-400 mt-2 ml-7 bg-gray-50 px-2 py-1 rounded-md border border-gray-200 self-start">ID: 5J7URZ7BP2PG</div>
               </li>
               <li className="flex items-start bg-white p-4 rounded-xl border border-gray-100 flex-col shadow-sm">
                 <div className="flex items-center">
                   <i className="fas fa-check-circle text-green-500 mr-3"></i>
                   <span className="font-bold text-gray-800">Facial Expression Recognition with Keras</span>
                 </div>
                 <div className="text-xs text-gray-400 mt-2 ml-7 bg-gray-50 px-2 py-1 rounded-md border border-gray-200 self-start">ID: T8DPEKAGWD9K</div>
               </li>
            </ul>
          </div>
      ...
      <section id="education" className="py-20 px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-5xl font-black mb-4 uppercase">Where it all <span className="text-blue-600">Began</span></h2>
          ...
          <div className="bg-[#F8F9FA] rounded-3xl p-10 border border-gray-100 inline-block text-left w-full shadow-md hover:shadow-lg transition-all">
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-6 md:space-y-0 md:space-x-8">
              ...
              <div className="flex-1">
                <a href="https://www.bits-pilani.ac.in" target="_blank" rel="noopener noreferrer" className="text-3xl font-black text-gray-900 mb-4 hover:text-blue-600 transition flex items-center gap-3">
                  BITS Pilani <i className="fas fa-external-link-alt text-lg text-gray-400"></i>
                </a>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-center bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <span className="font-bold text-gray-800">M.Sc. Economics (Hons.)</span>
                  </div>
                  <div className="flex items-center bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                    <i className="fas fa-laptop-code text-purple-500 text-xl mr-4"></i>
                    <span className="font-bold text-gray-800">B.E. Computer Science (Hons.)</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
                <h4 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-4">Spoken Languages</h4>
                <div className="flex flex-wrap justify-center md:justify-start gap-3">
                    <span className="bg-blue-50 text-blue-700 px-4 py-2 rounded-lg text-sm font-semibold border border-blue-100">English (Full Prof.)</span>
                    <span className="bg-blue-50 text-blue-700 px-4 py-2 rounded-lg text-sm font-semibold border border-blue-100">German (Elementary)</span>
                    <span className="bg-blue-50 text-blue-700 px-4 py-2 rounded-lg text-sm font-semibold border border-blue-100">Hindi (Native)</span>
                    <span className="bg-blue-50 text-blue-700 px-4 py-2 rounded-lg text-sm font-semibold border border-blue-100">Sanskrit (Elementary)</span>
                </div>
            </div>
          </div>
        </div>
